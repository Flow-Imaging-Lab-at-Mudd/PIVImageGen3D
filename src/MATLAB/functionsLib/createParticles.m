...
%     end
    ...
    index = 1;
    for iaK = 1:numberIAsZ+2
        winFront = (iaK - 2) * pivParameters.lastWindow(3) + ceil(imageProperties.marginsZ/2);
        ...
        for iaI = 1:numberIAsY+2
            ...
            for iaJ = 1:numberIAsX+2            
                ...
                z0s = random('unif', winFront + maxDisp, winFront + pivParameters.lastWindow(3) - eps - maxDisp,[totalInPlaneNrParticles,1]);
                ...
                for n=1:totalParticlesPerIA
                    if n  <= inPlaneParticlesPerIA
                        ...
                        %index = (iaK-1)*(numberIAsZ+2)*totalParticlesPerIA + (iaI-1) * (numberIAsX + 2) * totalParticlesPerIA + (iaJ-1) * totalParticlesPerIA + n
                ...
                particleMap.pivMap{iaI, iaJ, iaK} = particles;
            end       
        end
    end
